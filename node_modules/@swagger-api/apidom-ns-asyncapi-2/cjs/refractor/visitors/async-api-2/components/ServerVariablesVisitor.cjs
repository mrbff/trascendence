...
const ServerVariablesVisitor = (0, _stampit.default)(_MapVisitor.default, _FallbackVisitor.default, {
  props: {
    specPath: element => {
  ...
  init() {
    this.element = new _ComponentsServerVariables.default();
  },
  methods: {
...
var _default = exports.default = ServerVariablesVisitor;