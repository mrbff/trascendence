...
import { cloneDeep, cloneShallow, isElement, isMemberElement, isPrimitiveElement, isStringElement, visit, toValue } from '@swagger-api/apidom-core';
import { ApiDOMError } from '@swagger-api/apidom-error';
import { evaluate, uriToPointer } from '@swagger-api/apidom-json-pointer';
import { ChannelItemElement, getNodeType, isChannelItemElementExternal, isReferenceElementExternal, isReferenceLikeElement, keyMap, ReferenceElement } from '@swagger-api/apidom-ns-asyncapi-2';
import MaximumDereferenceDepthError from "../../../errors/MaximumDereferenceDepthError.mjs";
import MaximumResolverDepthError from "../../../errors/MaximumResolverDepthError.mjs";
  ...
  methods: {
    ...
    async ChannelItemElement(referencingElement, key, parent, path, ancestors) {
      ...
      const mergeAndAnnotateReferencedElement = refedElement => {
        ...
        const mergedElement = new ChannelItemElement([...refedElement.content], cloneDeep(refedElement.meta), cloneDeep(refedElement.attributes));
