...
declare class AncestorLineage<T extends Element> extends Array<WeakSet<T>> {
...
export { AncestorLineage as DereferenceAncestorLineage, DereferenceError, DereferenceStrategy, EvaluationJsonSchema$anchorError, EvaluationJsonSchemaUriError, File, HttpResolver, InvalidJsonSchema$anchorError, JsonSchema$anchorError, JsonSchemaUriError as JsonSchemaURIError, MaximumDereferenceDepthError, MaximumResolverDepthError, Parser, ParserError, PluginError, Reference, ReferenceSet, ResolveStrategy, Resolver, ResolverError, UnmatchedDereferenceStrategyError, UnmatchedResolveStrategyError, UnmatchedResolverError, dereference, dereferenceApiDOM, merge as mergeOptions, defaultOptions as options, parse, readFile, resolve, resolveApiDOM, url_d as url };
