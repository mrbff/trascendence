  ...
  methods: {
    ...
    async PathItemElement(referencingElement, key, parent, path, ancestors) {
      ...
      const mergeAndAnnotateReferencedElement = refedElement => {
        ...
        const mergedElement = new _apidomNsOpenapi.PathItemElement([...refedElement.content], (0, _apidomCore.cloneDeep)(referencedElement.meta), (0, _apidomCore.cloneDeep)(referencedElement.attributes));
