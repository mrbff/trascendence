...
var _MaximumResolverDepthError = _interopRequireDefault(require("../../../errors/MaximumResolverDepthError.cjs"));
  ...
  methods: {
    ...
    async toReference(uri) {
      ...
      if (this.reference.depth >= this.options.resolve.maxDepth) {
        throw new _MaximumResolverDepthError.default(`Maximum resolution depth of ${this.options.resolve.maxDepth} has been exceeded by file "${this.reference.uri}"`);
      }
    ...
    ChannelItemElement(channelItemElement) {
      ...
      const uri = (0, _apidomCore.toValue)(channelItemElement.$ref);
      const baseURI = this.toBaseURI(uri);
      if (!(0, _ramda.has)(baseURI, this.crawlingMap)) {
        this.crawlingMap[baseURI] = this.toReference(uri);
      }
    ...
    async crawlChannelItemElement(channelItemElement) {
      const reference = await this.toReference((0, _apidomCore.toValue)(channelItemElement.$ref));
      this.indirections.push(channelItemElement);
      const jsonPointer = (0, _apidomJsonPointer.uriToPointer)((0, _apidomCore.toValue)(channelItemElement.$ref));
...
var _default = exports.default = AsyncApi2ResolveVisitor;